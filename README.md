...
The conference room booking system in a conceptual system intended to manage:
- Room Availability
- Booking Requests
- Conflict Prevention
...
## 💪 Developer Onboarding Guide
 ...
 - Project artefacts can be found in the project folders. So far the artefacts available are:
    ...
    1) Sprint 1 checkpoint, dailies, planning, retrospective, review and summary
 ...
 - Technologies used so far and are planned to be used:
    ...
    5) Asana for sprint and project planning
...
2) Practicing Pull Requests with team members
3) Simulating collaboration with peers in a sprint
4) Serving as a template with room for added information and project files
